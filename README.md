...
LNP/BP Association is woking in the next version, RGB v0.11, which v0.10 isn't compatible and [will have Liquid](https://x.com/lnp_bp/status/1747930079252951058?s=20),  a sidechain created by the Blockstream
## Tech Overview
